        ...
        public bool IsPlayServicesAvailable()
        {
            ...
            if (resultCode != ConnectionResult.Success)
            {
                if (GoogleApiAvailability.Instance.IsUserResolvableError(resultCode))
                    Log.Debug("Debug", GoogleApiAvailability.Instance.GetErrorString(resultCode));
                else
                {
                    Log.Debug("Debug", "This device is not supported");
                    Finish();
                }
                return false;
            }
            ...
            {
                Log.Debug("Debug", "Google Play Services is available.");
                return true;
            }
        }
